...
test_people_num = dir(test_dir);
test_people_num = size(test_people_num,1)-2 ;
%%
%fprintf('======================== testing =========================\n');
...
for p = 1:test_people_num
    ...
    parfor i=1:n
        dist = test_unit([test_dir,num2str(i),'.wav'],feature_mat{i},etaf_debug,etaf_rmzero,etaf_fs );
